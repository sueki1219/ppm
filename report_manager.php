...
<div id="main">
<?php
	$sql = "SELECT contents, m_user.name FROM report JOIN m_user ON m_user.user_seq = report.user_seq WHERE report_seq = $report_seq";
	$result = mysql_query($sql);
	$row = mysql_fetch_array($result);
?>
提出者：<?php echo $row[1] ?><br>
<textarea rows="15" cols="120"><?php echo $row[0] ?></textarea>
<form method="post" action="report_manager_approval.php">
	<input type="hidden" name="report_seq" value="<?php echo $report_seq ?>" />
